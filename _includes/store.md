...
<div style="position: relative; text-align: center; margin: 1.75rem auto; padding: 1.5rem 2rem; background: linear-gradient(180deg, #2b1d10 0%, #1a1108 100%); border: 2px solid #a8823c; border-radius: 8px; box-shadow: 0 0 0 4px #0d0904, 0 0 20px rgba(212, 175, 90, 0.35), inset 0 1px 0 rgba(255, 255, 255, 0.06);">
  <div style="font-family: 'Cinzel', Georgia, serif; font-size: 0.75rem; letter-spacing: 0.3em; text-transform: uppercase; color: #c9a35f; opacity: 0.85; margin-bottom: 0.5rem;">
    ⚔ Support the Realm ⚔
  </div>
